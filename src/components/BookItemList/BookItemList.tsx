	...
	<div className="book-item-info">
	  ...
	  <div className="info-content">
		...
		<div className="info-params">
		  ...
		  <div className="info-params-item">
			<p>
			  <span>Published date</span> {bookItem.volumeInfo.publishedDate}
			</p>
		  </div>
		  <div className="info-params-item">
			<p>
